...
MAX_REQUESTS_PER_MINUTE_ALLOWED = int(os.getenv('MAX_REQUESTS_PER_MINUTE_ALLOWED', 5000))
DEFAULT_LOAD_TO_ADD = 1000  # default requests / min to consider for a new spider
