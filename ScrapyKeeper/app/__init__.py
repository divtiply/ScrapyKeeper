...
scheduler.add_job(sync_spiders, 'interval', seconds=20, id='sys_sync_spiders', replace_existing=True)
scheduler.add_job(reload_runnable_spider_job_execution, 'interval', seconds=30, id='sys_reload_job', replace_existing=True)
