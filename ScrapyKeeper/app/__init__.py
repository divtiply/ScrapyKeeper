...
from ScrapyKeeper.app.schedulers.common import sync_job_execution_status_job, sync_spiders, \
    reload_runnable_spider_job_execution, run_spiders_by_algorithm
...
scheduler.add_job(run_spiders_by_algorithm, 'interval', seconds=300, id='sys_reload_job', replace_existing=True)
